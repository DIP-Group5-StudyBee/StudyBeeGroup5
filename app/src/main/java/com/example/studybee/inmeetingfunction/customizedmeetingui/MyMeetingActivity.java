...
import com.example.studybee.inmeetingfunction.customizedmeetingui.audio.MeetingAudioCallback;
import com.example.studybee.inmeetingfunction.customizedmeetingui.audio.MeetingAudioHelper;
import com.example.studybee.inmeetingfunction.customizedmeetingui.other.MeetingCommonCallback;
import com.example.studybee.inmeetingfunction.customizedmeetingui.remotecontrol.MeetingRemoteControlHelper;
import com.example.studybee.inmeetingfunction.customizedmeetingui.share.MeetingShareCallback;
import com.example.studybee.inmeetingfunction.customizedmeetingui.share.MeetingShareHelper;
import com.example.studybee.inmeetingfunction.customizedmeetingui.user.MeetingUserCallback;
import com.example.studybee.inmeetingfunction.customizedmeetingui.video.MeetingVideoCallback;
import com.example.studybee.inmeetingfunction.customizedmeetingui.video.MeetingVideoHelper;
import com.example.studybee.inmeetingfunction.customizedmeetingui.view.MeetingOptionBar;
import com.example.studybee.inmeetingfunction.customizedmeetingui.view.MeetingWindowHelper;
import com.example.studybee.inmeetingfunction.customizedmeetingui.view.RealNameAuthDialog;
import com.example.studybee.inmeetingfunction.customizedmeetingui.view.adapter.AttenderVideoAdapter;
import com.example.studybee.inmeetingfunction.customizedmeetingui.view.share.AnnotateToolbar;
import com.example.studybee.inmeetingfunction.customizedmeetingui.view.share.CustomShareView;
import com.example.studybee.ui.APIUserStartJoinMeetingActivity;
import com.example.studybee.ui.BreakoutRoomsAdminActivity;
import com.example.studybee.ui.InitAuthSDKActivity;
import com.example.studybee.ui.LoginUserStartJoinMeetingActivity;
...
public class MyMeetingActivity extends FragmentActivity implements View.OnClickListener, MeetingVideoCallback.VideoEvent,
    ...
    MeetingOptionBar.MeetingOptionBarCallBack callBack = new MeetingOptionBar.MeetingOptionBarCallBack() {
        ...
        public void showMoreMenu(PopupWindow popupWindow) {
            popupWindow.showAtLocation((View) meetingOptionBar.getParent(), Gravity.BOTTOM | Gravity.RIGHT, 100, 150);
        }
    ...
    private void showPsswordDialog(final boolean needPassword, final boolean needDisplayName, final InMeetingEventHandler handler) {
        ...
        builder = new Dialog(this, R.style.ZMDialog);////////////////us.zoom.videomeetings
