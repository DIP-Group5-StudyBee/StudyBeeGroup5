...
public class RecordsActivity extends AppCompatActivity implements AuthConstants, OnTaskCompleted {
    ...
    public void onTaskCompleted(String response) {
        ...
        public void infotabClicked(View view){
            startActivity(new Intent(RecordsActivity.this, ProfileActivity_2.class));
        }

    public void recordtabClicked(View view){
        startActivity(new Intent(RecordsActivity.this, RecordsActivity.class));
    }
    public void recordPasttabClicked(View view){
        startActivity(new Intent(RecordsActivity.this, RecordsActivityPast.class));
    }
