...
import com.example.studybee.otherfeatures.scheduleforloginuser.PreMeetingExampleActivity;
...
//    private Button mBtnSSOLogin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mZoomSDK.isLoggedIn()) {
            finish();
            EmailLoginUserStartJoinActivity();
            return;
        }
...
//            layoutJoin.setVisibility(View.VISIBLE);
    ...
    private void EmailLoginUserStartJoinActivity() {/////////////////////////////hduihfuidfhew;uidlfhweuil
